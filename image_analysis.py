...
if __name__ == '__main__':
    ...
    y95B, y95G, y95R = histogram_BGR(imgmod95BGR)
    ...
    plt.legend()
    f2 = plt.figure(2)
    plt.plot(x, y50B, color="#03d5ff", label = "blue") 
    plt.plot(x, y50G, color="#0de009", label = "green") 
    plt.plot(x, y50R, color="#ff0a0a", label = "red") 
    plt.plot(x, y50, color="#4a4a4a", label = "luminosity") 
    plt.title("Luminosity and Color-Frequency Analysis, 50% Quality JPEG", loc='center')
    plt.legend()
    f3=plt.figure(3)
    plt.plot(x, y75B, color="#03d5ff", label = "blue") 
    plt.plot(x, y75G, color="#0de009", label = "green") 
    plt.plot(x, y75R, color="#ff0a0a", label = "red") 
    plt.plot(x, y75, color="#4a4a4a", label = "luminosity") 
    plt.title("Luminosity and Color-Frequency Analysis, 75% Quality JPEG", loc='center')
    plt.legend()
    f3=plt.figure(4)
    plt.plot(x, y95B, color="#03d5ff", label = "blue") 
    plt.plot(x, y95G, color="#0de009", label = "green") 
    plt.plot(x, y95R, color="#ff0a0a", label = "red") 
    plt.plot(x, y95, color="#4a4a4a", label = "luminosity") 
    plt.title("Luminosity and Color-Frequency Analysis, 95% Quality JPEG", loc='center')
    plt.legend()
    f3=plt.figure(4)
    plt.plot(x, yB, color="#03d5ff", label = "blue") 
    plt.plot(x, yG, color="#0de009", label = "green") 
    plt.plot(x, yR, color="#ff0a0a", label = "red") 
    plt.plot(x, y, color="#4a4a4a", label = "luminosity") 
